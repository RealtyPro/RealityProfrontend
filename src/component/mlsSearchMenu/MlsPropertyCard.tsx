...
export const MlsPropertyCard = ({ item,handleModal }: PropertyCardProps) => {
    ...
    return (
        ...
        <div className="property-card mls-property-card">
            <div className="mls-property-image">
                <Image
                    ...
                    <button className="favorite-btn"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45"
                            ...
                            <path
                                ...
                                stroke="#EDB75E" strokeWidth="2.73948" strokeLinecap="round"
            ...
            <div className="mls-property-info">
                <h3 className="mlscardheading">{item.title}</h3>
                <div className="property-features">
                    <span className="feature mls-gap-5">
