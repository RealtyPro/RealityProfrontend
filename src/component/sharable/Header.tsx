                ...
                <div className="container">
                    <div className="nav-brand">
                        <div className="logo ml-5">
                            ...
                            <span className="logo-text">AshuHomes</span>
                        </div>
                    </div>
                    ...
                    <nav className="nav-menu">
                        <ul>
                            ...
                            <li onClick={() => router.push('/neighborhoods')}>
                                <a href="neighborhoods"
                                    onClick={(e) => e.preventDefault()}
                                    className={activeHeader == "neighborhood" ? "nav-link active" : "nav-link"}>Neighborhoods</a></li>
